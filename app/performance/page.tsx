...
export const metadata = {
  title: "Performance | Mountaincamp",
  description: "Performance ist für Läufer:innen, die Struktur, Höhenmeter und ein echtes Ziel suchen. Details folgen 2027.",
}
...
export default function PerformancePage() {
  return (
    <div
      ...
      style={{ backgroundImage: "linear-gradient(to bottom, var(--mc-black), var(--mc-lake))" }}
    >
      <header className="container flex h-16 items-center justify-between md:h-20">
        ...
        <Link
          href="/"
          className="text-sm font-medium uppercase tracking-wide text-mc-dust hover:text-mc-mist transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-mc-orange focus-visible:outline-offset-4"
        >
          ← Mountaincamp
        </Link>
      </header>
      ...
      <main className="container flex flex-1 flex-col justify-center gap-6 py-16">
        <p className="font-oswald text-sm font-medium uppercase tracking-[0.2em] text-mc-mist">Coming Soon</p>
        ...
        <p className="max-w-[620px] text-lg leading-relaxed text-mc-dust">
          Performance ist für Läufer:innen, die Struktur, Höhenmeter und ein echtes Ziel suchen. Details folgen
          2027.
        </p>
        <div className="mt-4">
          <NotifySignupForm format="performance" accentClassName="focus-visible:outline-mc-mist" />
        </div>
      </main>
