...
const PRICES: Record<string, number | "Free"> = {
  ...
  "Kanu Gr. 1": 23,
  "Kanu Gr. 2": 23,
  "Ernährungsworkshop": 28,
  "Krafttraining Workshop": 28,
  "Trailrunning Technik Kurs": 28,
  "Morning Yoga": "Free",
...
const ACTIVITY_IMAGES: Record<string, string> = {
  ...
  "Trail Run Beginner": "/images/activities/trail-run.jpg",
  "Trail Run Fortgeschritten": "/images/activities/trail-run.jpg",
  "Trail Run Intermediate": "/images/activities/trail-run.jpg",
  "Trail Run Profi": "/images/activities/trail-run.jpg",
  "Trail Run Pro": "/images/activities/trail-run.jpg",
  "Trailrunning Technik Kurs": "/images/activities/krafttraining.jpg",
  "Trailrunning Technique": "/images/activities/krafttraining.jpg",
  "Krafttraining für Läufer*innen": "/images/activities/krafttraining.jpg",
  "Strength Training for Runners": "/images/activities/krafttraining.jpg",
  "Krafttraining Workshop": "/images/activities/krafttraining.jpg",
  "Strength Training Workshop": "/images/activities/krafttraining.jpg",
  "Kanu Gr. 1": "/images/activities/kanu.jpg",
  "Kanu Gr. 2": "/images/activities/kanu.jpg",
  "Kletterkurs 1": "/images/activities/klettern.jpg",
  "Kletterkurs 2": "/images/activities/klettern.jpg",
  "Climbing Course 1": "/images/activities/klettern.jpg",
  "Climbing Course 2": "/images/activities/klettern.jpg",
...
const SCHEDULE: Day[] = [
  {
    ...
    events: [
      ...
      { time: "16:30", name: "Check-in", category: "shared" },
  ...
  },
  {
    ...
    events: [
      ...
      { time: "08:30", name: "Trailrunning Technik Kurs", nameEn: "Trailrunning Technique", sub: "Gr. A1", groups: ["A1"], category: "workshop", showPrice: true },
      { time: "08:30", name: "Krafttraining für Läufer*innen", nameEn: "Strength Training for Runners", sub: "Gr. A2", groups: ["A2"], category: "workshop", showPrice: true },
      { time: "08:30", name: "Trail Run Fortgeschritten", nameEn: "Trail Run Intermediate", sub: "Gr. B | 11–17 km", groups: ["B"], category: "run" },
      { time: "08:30", name: "Trail Run Profi", nameEn: "Trail Run Pro", sub: "Gr. C | 17+ km | 800+ hm", groups: ["C"], category: "run" },
      { time: "10:30", name: "Krafttraining für Läufer*innen", nameEn: "Strength Training for Runners", sub: "Gr. A1", groups: ["A1"], category: "workshop", showPrice: true },
      { time: "10:30", name: "Trailrunning Technik Kurs", nameEn: "Trailrunning Technique", sub: "Gr. A2", groups: ["A2"], category: "workshop", showPrice: true },
      { time: "12:30", name: "Mittagessen", nameEn: "Lunch", duration: "45 Min", category: "meal" },
      { time: "13:30", name: "Kanu Gr. 1", nameEn: "Kayaking Group 1", sub: "14:00–15:30", groups: ["1"], category: "workshop", showPrice: true },
      { time: "13:30", name: "Linoleum-Druck", nameEn: "Linocut Printing", sub: "13:30–17:00", category: "workshop", showPrice: true },
      { time: "15:00", name: "Kanu Gr. 2", nameEn: "Kayaking Group 2", sub: "15:30–17:00", groups: ["2"], category: "workshop", showPrice: true },
      { time: "16:30", name: "Ernährungsworkshop", nameEn: "Nutrition Workshop", sub: "16:30–18:30", category: "workshop", showPrice: true },
      { time: "18:30", name: "Dinner", duration: "45 Min", category: "meal" },
  ...
  },
  {
    ...
    events: [
      { time: "05:00", name: "Sunrise Hike", sub: "5:00–6:30", category: "yoga", showPrice: true },
      { time: "06:30", name: "Morning Yoga", duration: "60 Min", category: "yoga", showPrice: true },
      { time: "07:30", name: "Frühstück", nameEn: "Breakfast", duration: "45 Min", category: "meal" },
      { time: "08:15", name: "Treffpunkt & Briefing", nameEn: "Meeting Point & Briefing", duration: "15 Min", category: "shared" },
      { time: "08:30", name: "Trail Run Anfänger", nameEn: "Trail Run Beginner", sub: "Gr. A | 8–13 km", groups: ["A"], category: "run" },
      { time: "08:30", name: "Trail Run Fortgeschritten", nameEn: "Trail Run Intermediate", sub: "Gr. B | 11–17 km", groups: ["B"], category: "run" },
      { time: "08:30", name: "Trail Run Profi", nameEn: "Trail Run Pro", sub: "Gr. C | 17+ km", groups: ["C"], category: "run" },
      { time: "12:30", name: "Mittagessen", nameEn: "Lunch", duration: "45 Min", category: "meal" },
      { time: "13:30", name: "Kletterkurs 1", nameEn: "Climbing Course 1", sub: "13:30–15:30", category: "workshop", showPrice: true },
      { time: "13:30", name: "Bogenschießen", nameEn: "Archery", sub: "13:30–15:30", category: "workshop", showPrice: true },
      { time: "13:30", name: "Upcycling 1", sub: "13:30–15:30", category: "workshop", showPrice: true },
      { time: "15:45", name: "Kletterkurs 2", nameEn: "Climbing Course 2", sub: "15:45–17:45", category: "workshop", showPrice: true },
      { time: "17:00", name: "Krafttraining Workshop", nameEn: "Strength Training Workshop", sub: "17:00–18:30", category: "workshop", showPrice: true },
      { time: "15:30", name: "Upcycling 2", sub: "15:30–17:30", category: "workshop", showPrice: true },
      { time: "18:30", name: "Dinner", duration: "45 Min", category: "meal" },
  ...
  },
  {
    ...
    events: [
      ...
      { time: "08:30", name: "Trail Run Profi", nameEn: "Trail Run Pro", sub: "Gr. C | 17+ km", groups: ["C"], category: "run" },
      { time: "12:30", name: "Mittagessen", nameEn: "Lunch", duration: "45 Min", category: "meal" },
      { time: "14:00", name: "MTB-Tour", sub: "14:00–16:15", category: "workshop", showPrice: true },
      { time: "13:30", name: "Töpfern", nameEn: "Pottery", sub: "13:30–15:00", category: "workshop", showPrice: true },
      { time: "15:15", name: "Töpfern", nameEn: "Pottery", sub: "15:15–16:45", category: "workshop", showPrice: true },
      { time: "18:30", name: "Dinner", duration: "45 Min", category: "meal" },
      { time: "19:30", name: "Abschlussabend", nameEn: "Closing Evening", category: "evening" },
    ],
  },
  {
    day: "Sonntag",
    ...
    events: [
      ...
      { time: "06:30", name: "Morning Yoga", duration: "60 Min", category: "yoga", showPrice: true },
      { time: "07:30", name: "Frühstück", nameEn: "Breakfast", duration: "45 Min", category: "meal" },
      { time: "08:30", name: "Abreise", nameEn: "Departure", sub: "ab 8:30", subEn: "from 8:30", category: "travel" },
    ],
  },
]
