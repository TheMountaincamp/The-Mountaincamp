...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "trailrunning urlaub österreich",
    "trailrunning vacation austria",
    "trailrunning wochenende alpen",
    "trailrunning weekend alps",
    "trailrunning reise österreich",
    "trailrunning holiday austria",
    "bergläufer camp österreich",
    "mountain runner camp austria",
    "laufcamp alpen",
    "running camp alps",
    "trailrunning coaching österreich",
    ...
    "Pinzgau trail running",
    "Krimmler Wasserfälle trail",
  ],
  authors: [{ name: "The Mountaincamp Team" }],
  creator: "The Mountaincamp",
  publisher: "The Mountaincamp",
  category: "Sports & Recreation",
  classification: "Sports Event, Trail Running, Mountain Sports, Outdoor Activities",
  formatDetection: {
    email: false,
    address: false,
    telephone: false,
  ...
  other: {
    "geo.region": "AT-5",
    "geo.placename": "Hochkrimml, Salzburg, Austria",
    "geo.position": "47.2393;12.1735",
    ICBM: "47.2393, 12.1735",
    "DC.title": "The Mountaincamp - Trailrunning Camp Austria & Österreich",
    "DC.description": "Premier trailrunning camp for beginners in the Austrian Alps",
    "DC.subject": "Trail Running, Mountain Sports, Alpine Training, Outdoor Adventure",
    "DC.language": "de, en",
  },
  openGraph: {
    title: "Trailrunning Camp Österreich & Austria für Anfänger | The Mountaincamp 2026 in den Alpen",
